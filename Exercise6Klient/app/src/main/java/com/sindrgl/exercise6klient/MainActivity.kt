package com.sindrgl.exercise6klient
...
import com.sindrgl.exercise6klient.ui.theme.Exercise6KlientTheme
...
fun SendMessageView(sendToServer: suspend (String) -> Unit) {
    ...
    Column {
        Text("Chat med andre tilkoblede klienter!", fontSize = 20.sp)
        Divider()
        Row() {
            TextField(
